...
class Transform:
    ...
    def scdDataset(self,df,lookupDataLocation,piiColumns,datasetName):
        ...
        #Creates mergekey in table based on masked 
        # userid and advertisement id
        stagedUpdates = (
...
if __name__ == "__main__":
    ...
    if "actives" in fileName.lower() and fileName.endswith('.parquet'):
        ...
        dfActives = trans_obj.scdDataset(masked_actives,config_obj.lookupDataLocation,config_obj.piiColumns,fileName)
        trans_obj.writeDataByPartition(dfActives,config_obj.dest_staging_actives,"parquet",config_obj.actives_partition_cols)

    elif "view" in fileName.lower() and fileName.endswith('.parquet'):
        ...
        dfViewer = trans_obj.scdDataset(masked_viewership,config_obj.lookupDataLocation,config_obj.piiColumns,fileName)
